...
public class Init extends Activity implements SensorEventListener {
  ...
  public void onSensorChanged(SensorEvent event) {
    ...
    if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
      ...
      TextView yText = (TextView) findViewById(R.id.sensor_y);
      TextView zText = (TextView) findViewById(R.id.sensor_z);

      xText.setText("X軸的重力分量是 " + x);
      yText.setText("Y軸的重力分量是 " + y);
      zText.setText("Z軸的重力分量是 " + z);
